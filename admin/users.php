                   ...
                   <?php
                      ...
                      <div class="card">
                         ...
                         <div class="card-body">
                           <div class="row">
                             ...
                             <div class="form-group">
                                 <label>Re-Type Password</label>
                                 <input type="password" name="repassword" class="form-control" placeholder="xxxxxx">
                             </div>
                      ...
                      else if( $do == "Update")
                      {
                          if(isset($_POST['updateUser']))
                          {
                           ...
                           // Both for password and picture with all data changes
                            if( !empty($password)  && !empty($image))
                            {
                              ...
                              // Delete image if image already exists
                            ...
                            // Only Password with all changes the data
                            else if (!empty($password)  && empty($image) )
                            {
                              ...
                              // Only Picture with all changes the data
                              else if (empty($password)  && !empty($image) )
                              {
